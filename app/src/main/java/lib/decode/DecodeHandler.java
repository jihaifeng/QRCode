...
import com.jihf.jihf.qrcode.R;
import java.io.File;
import java.io.FileOutputStream;
import lib.CaptureActivity;
import lib.ZbarManager;
import lib.bitmap.PlanarYUVLuminanceSource;
		...
		if (result != null) {
			if (activity.isNeedCapture()) {
				...
				PlanarYUVLuminanceSource
						source = new PlanarYUVLuminanceSource(rotatedData, width, height, activity.getX(), activity.getY(),
